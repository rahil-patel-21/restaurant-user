...
class S {
  ...
  /// `Here starts the language for phone validation`
  String get kriacoes_mobile_phone_authentication_by_kriacoes {
    return Intl.message(
      'Here starts the language for phone validation',
      name: 'kriacoes_mobile_phone_authentication_by_kriacoes',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Not authorized!`
  String get kriacoes_mobile_not_authorized_title {
    return Intl.message(
      'Not authorized!',
      name: 'kriacoes_mobile_not_authorized_title',
      desc: '',
      args: [],
    );
  }

  /// `This application is not authorized, please check your firebase credentials.`
  String get kriacoes_mobile_not_authorized_msg {
    return Intl.message(
      'This application is not authorized, please check your firebase credentials.',
      name: 'kriacoes_mobile_not_authorized_msg',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Connection error!`
  String get kriacoes_mobile_network_title {
    return Intl.message(
      'Connection error!',
      name: 'kriacoes_mobile_network_title',
      desc: '',
      args: [],
    );
  }
  ...
  String get kriacoes_mobile_network_msg {
    return Intl.message(
      'There was an error with the network, please try again.',
      name: 'kriacoes_mobile_network_msg',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Invalid format!`
  String get kriacoes_mobile_invalid_format_title {
    return Intl.message(
      'Invalid format!',
      name: 'kriacoes_mobile_invalid_format_title',
      desc: '',
      args: [],
    );
  }

  /// `The format of the phone number provided is incorrect. Enter the phone number: [subscriber number including area code].`
  String get kriacoes_mobile_invalid_format_msg {
    return Intl.message(
      'The format of the phone number provided is incorrect. Enter the phone number: [subscriber number including area code].',
      name: 'kriacoes_mobile_invalid_format_msg',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Number too short!`
  String get kriacoes_mobile_too_short_title {
    return Intl.message(
      'Number too short!',
      name: 'kriacoes_mobile_too_short_title',
      desc: '',
      args: [],
    );
  }

  /// `The phone number provided is incorrect. It is too short to be a phone, check and try again ...`
  String get kriacoes_mobile_too_short_msg {
    return Intl.message(
      'The phone number provided is incorrect. It is too short to be a phone, check and try again ...',
      name: 'kriacoes_mobile_too_short_msg',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Number too big!`
  String get kriacoes_mobile_too_long_title {
    return Intl.message(
      'Number too big!',
      name: 'kriacoes_mobile_too_long_title',
      desc: '',
      args: [],
    );
  }

  /// `The phone number provided is incorrect. It is too long to be a phone, please check and try again ...`
  String get kriacoes_mobile_too_long_msg {
    return Intl.message(
      'The phone number provided is incorrect. It is too long to be a phone, please check and try again ...',
      name: 'kriacoes_mobile_too_long_msg',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Number blocked!`
  String get kriacoes_mobile_we_have_blocked_title {
    return Intl.message(
      'Number blocked!',
      name: 'kriacoes_mobile_we_have_blocked_title',
      desc: '',
      args: [],
    );
  }

  /// `We blocked all requests for this device due to unusual activity. Please try later.`
  String get kriacoes_mobile_we_have_blocked_msg {
    return Intl.message(
      'We blocked all requests for this device due to unusual activity. Please try later.',
      name: 'kriacoes_mobile_we_have_blocked_msg',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Oops ...`
  String get kriacoes_mobile_generic_title {
    return Intl.message(
      'Oops ...',
      name: 'kriacoes_mobile_generic_title',
      desc: '',
      args: [],
    );
  }
  ...
  /// `An error occurred:`
  String get kriacoes_mobile_generic_msg {
    return Intl.message(
      'An error occurred:',
      name: 'kriacoes_mobile_generic_msg',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Enter the code`
  String get kriacoes_mobile_give_the_code {
    return Intl.message(
      'Enter the code',
      name: 'kriacoes_mobile_give_the_code',
      desc: '',
      args: [],
    );
  }
  ...
  String get kriacoes_mobile_wrong_size_code {
    return Intl.message(
      'The code must be 6 digits!',
      name: 'kriacoes_mobile_wrong_size_code',
      desc: '',
      args: [],
    );
  }
  ...
  String get kriacoes_mobile_wrong_code {
    return Intl.message(
      'The code entered is invalid!',
      name: 'kriacoes_mobile_wrong_code',
      desc: '',
      args: [],
    );
  }
  ...
  String get kriacoes_mobile_empty_code {
    return Intl.message(
      'The code cannot be empty!',
      name: 'kriacoes_mobile_empty_code',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Submit Code`
  String get kriacoes_mobile_send_code {
    return Intl.message(
      'Submit Code',
      name: 'kriacoes_mobile_send_code',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Sms sent to`
  String get kriacoes_mobile_sms_send_code {
    return Intl.message(
      'Sms sent to',
      name: 'kriacoes_mobile_sms_send_code',
      desc: '',
      args: [],
    );
  }
  ...
  /// `CHECK`
  String get kriacoes_mobile_btn_check {
    return Intl.message(
      'CHECK',
      name: 'kriacoes_mobile_btn_check',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Let's check phone ...`
  String get kriacoes_mobile_header {
    return Intl.message(
      'Let\'s check phone ...',
      name: 'kriacoes_mobile_header',
      desc: '',
      args: [],
    );
  }

  /// `We will send you an SMS with the unique use code for the cell phone number entered`
  String get kriacoes_mobile_sub_header {
    return Intl.message(
      'We will send you an SMS with the unique use code for the cell phone number entered',
      name: 'kriacoes_mobile_sub_header',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Telephone`
  String get kriacoes_mobile_phone {
    return Intl.message(
      'Telephone',
      name: 'kriacoes_mobile_phone',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Enter your phone ...`
  String get kriacoes_mobile_hint {
    return Intl.message(
      'Enter your phone ...',
      name: 'kriacoes_mobile_hint',
      desc: '',
      args: [],
    );
  }
  ...
  String get kriacoes_mobile_empty {
    return Intl.message(
      'The phone cannot be empty!',
      name: 'kriacoes_mobile_empty',
      desc: '',
      args: [],
    );
  }

  /// `The phone number provided is not correct, enter the country code, operator prefix and number`
  String get kriacoes_mobile_incorrect {
    return Intl.message(
      'The phone number provided is not correct, enter the country code, operator prefix and number',
      name: 'kriacoes_mobile_incorrect',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Phone confirmed!`
  String get kriacoes_mobile_phone_confirmed_header {
    return Intl.message(
      'Phone confirmed!',
      name: 'kriacoes_mobile_phone_confirmed_header',
      desc: '',
      args: [],
    );
  }

  /// `Your phone number has been successfully confirmed, now complete your registration.`
  String get kriacoes_mobile_phone_signup_step {
    return Intl.message(
      'Your phone number has been successfully confirmed, now complete your registration.',
      name: 'kriacoes_mobile_phone_signup_step',
      desc: '',
      args: [],
    );
  }
  ...
  String get kriacoes_mobile_btn_signup {
    return Intl.message(
      'CONTINUE REGISTRATION',
      name: 'kriacoes_mobile_btn_signup',
      desc: '',
      args: [],
    );
  }
  ...
  /// `The code entered is invalid!`
  String get kriacoes_mobile_error_invalid_verification_code {
    return Intl.message(
      'The code entered is invalid!',
      name: 'kriacoes_mobile_error_invalid_verification_code',
      desc: '',
      args: [],
    );
  }
  ...
  /// `The code cannot be empty!`
  String get kriacoes_mobile_cannot_create_phoneauthcredential {
    return Intl.message(
      'The code cannot be empty!',
      name: 'kriacoes_mobile_cannot_create_phoneauthcredential',
      desc: '',
      args: [],
    );
  }

  /// `The code sending has expired, request a new code ...`
  String get kriacoes_mobile_error_session_expired {
    return Intl.message(
      'The code sending has expired, request a new code ...',
      name: 'kriacoes_mobile_error_session_expired',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Change Phone`
  String get kriacoes_mobile_change_number_title {
    return Intl.message(
      'Change Phone',
      name: 'kriacoes_mobile_change_number_title',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Your phone`
  String get kriacoes_mobile_change_number_msg_1 {
    return Intl.message(
      'Your phone',
      name: 'kriacoes_mobile_change_number_msg_1',
      desc: '',
      args: [],
    );
  }

  /// `has been verified, to change your phone number you will need to do the verification again, would you like to change it?`
  String get kriacoes_mobile_change_number_msg_2 {
    return Intl.message(
      'has been verified, to change your phone number you will need to do the verification again, would you like to change it?',
      name: 'kriacoes_mobile_change_number_msg_2',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Change`
  String get kriacoes_mobile_change_number_yes {
    return Intl.message(
      'Change',
      name: 'kriacoes_mobile_change_number_yes',
      desc: '',
      args: [],
    );
  }
  ...
  /// `No`
  String get kriacoes_mobile_change_number_no {
    return Intl.message(
      'No',
      name: 'kriacoes_mobile_change_number_no',
      desc: '',
      args: [],
    );
  }
