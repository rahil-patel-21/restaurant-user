...
import '../elements/CartBottomDetailsWidgetCheckout.dart';
...
class _DeliveryPickupWidgetState extends StateMVC<DeliveryPickupWidget> {
  ...
  _DeliveryPickupWidgetState() : super(DeliveryPickupController()) {
    ...
    for (var i = 0; i < _con.deliveryAddress.length; i++) {
      list.add(DeliveryAddressesItemWidget(
        paymentMethod: _con.getDeliveryMethod(),
        address: _con.deliveryAddress[i],
        onPressed: (Address _address) {
          if (_con.deliveryAddress[i].id == null ||
              _con.deliveryAddress[i].id == 'null') {
            ...
            _con.toggleDelivery(_con.deliveryAddress, i);
            _con.addAddress(_address);
          }
        },
      ));
...
//      widget.delivery = widget.list.pickupList.elementAt(1);
    ...
    return Scaffold(
      ...
      bottomNavigationBar: CartBottomDetailsWidgetCheckout(con: _con),
      appBar: AppBar(
