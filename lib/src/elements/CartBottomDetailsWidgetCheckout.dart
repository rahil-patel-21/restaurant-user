...
class CartBottomDetailsWidgetCheckout extends StatelessWidget {
  const CartBottomDetailsWidgetCheckout({
    Key key,
  ...
  var allowCheckout = _con.allowCheckout(_con);
                  ...
                  Stack(
                    ...
                    children: <Widget>[
                      SizedBox(
                        ...
                        child: FlatButton(
                          onPressed: () {
                           _con.validCheckout(context, allowCheckout, _con.total >_con.orderLimit());
                          },
